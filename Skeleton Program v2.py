...
def DisplayRecentScores(RecentScores):
  ...
  print('Recent Scores: ')
  print()
  print("|{0:<10}|{1:<5}|{2:<9}|".format("Name","Score","Date"))
  for Count in range(1, NO_OF_RECENT_SCORES + 1):
    print("|{0:<10}|{1:<5}|{2:<9}|".format(RecentScores[Count].Name,RecentScores[Count].Score,RecentScores[Count].Date))
  print()
...
def UpdateRecentScores(RecentScores, Score, current_date):
  user_input = input("Do you want to add your score to the high score table?(y or n): ")
...
def PlayGame(Deck, RecentScores):
  ...
  if GameOver:
    ...
    UpdateRecentScores(RecentScores, NoOfCardsTurnedOver - 2, current_date)
  else:
    DisplayEndOfGameMessage(51)
    UpdateRecentScores(RecentScores, 51, current_date)
